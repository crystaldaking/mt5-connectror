...
class Mt5Client
{
    ...
    public function UserGet(array $params)
    {
        ...
        $result = $this->httpClient->get('/user_get',['query' => $params]);
    ...
    public function UserBalance(array $params)
	{
		...
		$result = $this->httpClient->get('/trade_balance', ['query' => $params]);
    ...
    public function ClientAdd(array $params)
    {
        ...
        $result = $this->httpClient->post('/client_add',[RequestOptions::JSON => $params]);
    ...
    public function ClientGet(array $params)
    {
        ...
        $result = $this->httpClient->get('/client_get',['query' => $params]);
    ...
    public function ClientUpdate(array $params)
    {
        ...
        $result = $this->httpClient->post('/client_update',[RequestOptions::JSON => $params]);
    ...
    public function DailyReportGet(array $params)
    {
        ...
        $result = $this->httpClient->get('/daily_get',['query' => $params]);
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function SendCustomCommand(string $commandName,array $params)
    {
        if (empty($this->httpClient)){
            return false;
        }

        $result = $this->httpClient->get($commandName,['query' => $params]);
        if ($result->getStatusCode() != 200){
            return ['Status' => 'Server error: '.$result->getStatusCode()];
        }
        $result = json_decode($result->getBody(),true);
    ...
    public function OrderGetBatch(array $params)
    {
        ...
        $result = $this->httpClient->get('/order_get_batch',['query' => $params]);
        if ($result->getStatusCode() != 200){
            return ['Status' => 'Server error: '.$result->getStatusCode()];
        }
        $result = json_decode($result->getBody(),true);
    ...
    public function HistoryGetBatch(array $params)
    {
        ...
        $result = $this->httpClient->get('/history_get_batch',['query' => $params]);
        if ($result->getStatusCode() != 200){
            return ['Status' => 'Server error: '.$result->getStatusCode()];
        }
        $result = json_decode($result->getBody(),true);
    ...
    public function SymbolGetGroup(array $params)
    {
        ...
        $result = $this->httpClient->get('/symbol_get_group',['query' => $params]);
        if ($result->getStatusCode() != 200){
            return ['Status' => 'Server error: '.$result->getStatusCode()];
        }
        $result = json_decode($result->getBody(),true);
    ...
    public function SymbolAddBatch(array $params)
    {
        ...
        $result = $this->httpClient->post('/symbol_add_batch',['query' => $params]);
        if ($result->getStatusCode() != 200){
            return ['Status' => 'Server error: '.$result->getStatusCode()];
        }
        $result = json_decode($result->getBody(),true);
